...
User-facing docs, tutorials, public-goods, and Gradient Papers v3 — kept as 4 sibling top-level directories
...
```
--path docs/ --path Tutorials/ --path public-goods/ --path gradient_papers_v3/
```
