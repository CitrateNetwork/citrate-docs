...
# Active audit reference — `citrate-docs`
...
2026-05-31 as a **Tier 3 — content review** surface.

- Audit root: `citrate-security/audits/2026-05-31-federation-deep-audit/`
- This repo's folder: `.../per-repo/citrate-docs/` — `MAP.md` (architecture + data-flow +
...
- Phase-1 mapping complete; see `per-repo/citrate-docs/MAP.md` for the mapped surface and
