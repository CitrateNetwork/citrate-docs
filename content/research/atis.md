...
**ATIS** proposes computing the importance score itself in **analog hardware** —
a Field-Programmable Analog Array (FPAA) sitting before the digital Q/K
...
prototype, no SPICE simulation. The software importance-MLP is "specified —
researchers' choice," and the TEE-attestation extension for custom hardware is
