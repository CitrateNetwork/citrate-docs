...
- Public Citrate Network. Every node operator is identity-checked through CLEAR; SOC 2 is the general floor
...
through CLEAR; Citrate keeps the verification result, not the personal data behind it.
