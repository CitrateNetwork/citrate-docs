...
export const VIEWERS: Viewer[] = [
  ...
  {
    id: "enterprise",
    label: "Enterprise seat (defense_prime)",
    description: "Commercial seat scoped to org 'defense_prime'. Sees defense_prime's private space, not other orgs'.",
    session: session({
      authenticated: true,
      sub: "uuid:enterprise-defense_prime-014",
      walletAddress: "0xee01...b00e",
      email: "architect@defense_prime.example",
      kycStatus: "verified",
  ...
  {
    id: "academic",
    label: "Academic partner (academic_partner)",
    description: "Academic tier — full Gradient Papers, TLA+ corpus, research portal, testnet access.",
    session: session({
      authenticated: true,
      sub: "uuid:academic_partner-pi",
      email: "pi@academic_partner.example",
      kycStatus: "verified",
